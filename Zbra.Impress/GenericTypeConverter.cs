    ...
    public class GenericTypeConverter
    {
        ...
        protected object DoConvert(string value, Type type)
        {
            ...
            if (func.HasValue)
            {
                ...
                {
                    throw new InvalidFormatConverterException(value + " is not valid for a conversion to " + type.Name, e);
                }
            }
            else
            {
                throw new InvalidTypeConverterException("Cannot convert type " + type.Name);
            }
        }
        ...
        protected T DoConvert<T>(string value)
        {
            ...
            if (func.HasValue)
            {
                ...
                {
                    throw new InvalidFormatConverterException(value + " is not valid for a conversion to " + typeof(T).Name, e);
                }
            }
            else
            {
